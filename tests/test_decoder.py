...
from decoder import (
    arrange_dec_in_matrices,
    multiply_matrices,
    request_key,
    calculate_invertible,
...
class TestDecoder(unittest.TestCase):
    ...
    def test_convert_message(self):
        ...
        self.assertEqual(
            convert_message_to_dec("SŢÕVŝØOƙóMŢÏEŰá"),
            [83, 354, 213, 86, 349, 216, 79, 409, 243, 77, 354, 207, 69, 368, 225],
        )
    ...
    def test_convert_dec_in_char(self):
        result = convert_dec_in_char(
            [83, 65, 76, 86, 65, 68, 79, 82, 84, 77, 65, 82, 69, 78, 65]
        )
